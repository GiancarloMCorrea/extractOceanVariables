...
# MUR analysis (0.01 deg resolution):
envirSource <- "HYCOM"
timeResolution = "day" # 'day' or 'month'
datasetid <- "nrlHycomGLBu008e910D_LonPM180" # daily: "jplMURSST41", monthly: "jplMURSST41mday"
url <- eurl()
info(datasetid = datasetid, url = url) # check nae of 'field'
fields <- "salinity"
flip_direction <- "v" # is rotation needed?: 'v' or 'h' or 'none
