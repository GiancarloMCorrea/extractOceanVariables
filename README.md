...
> **Limitations** The current version ignores the z dimension (i.e., depth). Therefore, it only works for surface oceanographic variables or variables for which depth is not relevant. If you need to download data for a specific or multiple depths, you will need to modify the code.
